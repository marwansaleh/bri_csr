...
<script type="text/javascript">    
    ...
    $(document).ready(function(){
        loadPrograms(0,$('select#wilayah').val(),'');
        ...
        $('select#wilayah').change(function(){
            ...
            loadPrograms(0, wilayah, keyword);
        })
    ...
    {        
        ...
        $.post("ajax",{input_function:'loadProgramsByWilayah',param:page,wilayah:wilayah,search_str:keyword},function(result){
            ...
            if (data['found']>0){
                ...
                createNavigator(page, wilayah, keyword, data['pages']);
            }else{
    ...
    function createNavigator(page_active, wilayah, keyword, num_of_pages)
    {
        //clear old navigation
        $('ul.navigation').empty();
        ...
        if (num_of_pages>1){
            for(var i=0;i<num_of_pages;i++){
                var s="<li onclick='loadPrograms("+i+",\""+wilayah+"\",\""+keyword+"\");'";
