...
<script type="text/javascript">    
    $(document).ready(function(){
        ...
        $('li#btn_print').click(function(){
            ...
            var wnd = window.open("reports_print/1/"+month_from+","+month_to+"/"+year_from+","+year_to+"/"+fund_type,"Print");
            wnd.focus();
        })
        $('li#btn_export').click(function(){            
            var table_content = $('div.content:last').html();
            var filename = "report_wilayah.xls";
